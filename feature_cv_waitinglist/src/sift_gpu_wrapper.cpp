...
const static int max_keypoints = 5000;
...
SiftGPUWrapper::SiftGPUWrapper() {
    ...
    int max_features = max_keypoints; //ParameterServer::instance()->get<int>("max_keypoints");
    ...
    char * argv[] = {method,  subpixelKey, subpixelValue, max_flag, max_feat_char, verbosity, first_octave, first_octave_val};//, "-t", "0.005"};
    siftgpu->ParseParam(8, argv);
